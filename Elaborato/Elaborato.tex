\documentclass[12pt, twoside, letterpaper, cleardoublepage=empty]{report}
...
\begin{document}
	...
	\vspace*{\stretch{1}}
	\begin{flushright}
	\itshape Ai miei genitori,\\
	che hanno avuto il coraggio di abbandonare\\la loro vita in Perù per darmi questa possibilità.
	\end{flushright}
	\vspace{\stretch{2}}
	%\cleardoublepage
	\chapter*{Ringraziamenti} \pagenumbering{roman} \addcontentsline{toc}{chapter}{Ringraziamenti}
		Vorrei dedicare questa pagina a tutti coloro che mi hanno supportato lungo questo percorso durato 3 anni.

		Ringrazio di cuore il mio relatore Dario Malchiodi nonché mio professore. Lui mi ha trasmesso la sua passione per la statistica e la data science, motivo per cui ho deciso di realizzare questo lavoro. È stato davvero un relatore impeccabile, mi ha aiutato moltissimo quando ero in difficoltà sia durante il tirocinio che durante la stesura di questo testo.

		Ringrazio anche alla mia correlatrice Anna Maria Zanaboni, i cui consigli mi sono serviti per prendere la giusta strada e migliorare la qualità del mio lavoro.

		Un ringraziamento speciale va fatto anche alla mia famiglia, senza il loro supporto non avrei mai avuto la possibilità di raggiungere questo traguardo.

		Infine ringrazio le mie pecore, un gruppo di amici fantastico con cui ho condiviso questi 3 anni nei momenti difficili e nel divertimento. 
