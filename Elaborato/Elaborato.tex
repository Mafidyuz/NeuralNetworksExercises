...
\begin{document}
	...
	\chapter{Reti neurali}
		...
		\section{Apprendimento di una rete neurale}
			...
			\subsection{Quando smettere di apprendere}
	...
	\begin{thebibliography}{9}
		\bibitem{kriesel} David Kriesel. \textit{A Brief Introduction to Neural Networks}. University of Bonn, 2005.

		\bibitem{shwartz} Shai Shalev-Shwartz, Shai Ben-David. \textit{Understanding Machine Learning: From Theory to Algorithms.} Cambridge University Press, 2014.
