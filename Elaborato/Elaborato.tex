...
\begin{document}
	...
	\section{Classificazione e reingegnerizzazione dei dati} 
		...
		\subsection{Dataset sugli incidenti stradali}
			...
			\begin{itemize}
				\item \texttt{max\_iter: [100,1000,5000,10000],}
			...
			\end{itemize}
			Come ci si poteva aspettare, lo score ottenuto con la feature \texttt{DATA} presente è leggermente più alta (Tabella \ref{tab:score_con_e_senza_data}). 
			...
			\subsubsection{PCA come totale delle lesioni invece che la somma}		
