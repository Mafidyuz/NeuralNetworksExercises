...
class BaseMultilayerPerceptron(BaseEstimator, metaclass=ABCMeta):
    ...
    def __init__(self, hidden_layer_sizes, activation, solver,
        ...
        self.activations_before_derivative = {} 
    ...
    def _forward_pass(self, activations):
        ...
        for i in range(self.n_layers_ - 1):
            ...
            if (i + 1) != (self.n_layers_ - 1):
                self.activations_before_derivative[i + 1] = activations[i + 1]
    ...
    def _backprop(self, X, y, activations, deltas, coef_grads,
        ...
        for i in range(self.n_layers_ - 2, 0, -1):
            ...
            if self.activation == 'normal':
                inplace_derivative(activations[i], deltas[i - 1], self.activations_before_derivative[i])
            else:
